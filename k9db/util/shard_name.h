#ifndef K9DB_UTIL_SHARD_NAME_H_
#define K9DB_UTIL_SHARD_NAME_H_
...
template <>
struct hash<k9db::util::ShardName> {
  size_t operator()(const k9db::util::ShardName &o) const { return o.Hash(); }
};

}  // namespace std

#endif  // K9DB_UTIL_SHARD_NAME_H_
