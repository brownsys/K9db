#ifndef K9DB_UTIL_ITERATOR_H_
#define K9DB_UTIL_ITERATOR_H_
...
template <typename R1, typename R2>
void swap(k9db::util::RefPair<R1, R2> l, k9db::util::RefPair<R1, R2> r) {
...
template <typename I>
struct tuple_size<k9db::util::Iterable<I>> : integral_constant<size_t, 2> {};

template <size_t Index, typename I>
struct tuple_element<Index, k9db::util::Iterable<I>>
    : tuple_element<Index, tuple<I, I>> {};

}  // namespace std

#endif  // K9DB_UTIL_ITERATOR_H_
