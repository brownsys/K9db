...
#ifndef K9DB_SQLAST_AST_VISITORS_H_
#define K9DB_SQLAST_AST_VISITORS_H_
...
#include "k9db/sqlast/ast_schema.h"
#include "k9db/sqlast/ast_statements.h"
...
#define K9DB_VISIT_CAST(type) static_cast<type *>(this)->Visit(visitor)

template <class T>
T AbstractStatement::Visit(AbstractVisitor<T> *visitor) const {
  switch (this->type()) {
    case sqlast::AbstractStatement::Type::CREATE_TABLE:
      return K9DB_VISIT_CAST(const CreateTable);
    case sqlast::AbstractStatement::Type::CREATE_INDEX:
      return K9DB_VISIT_CAST(const CreateIndex);
    case sqlast::AbstractStatement::Type::CREATE_VIEW:
      return K9DB_VISIT_CAST(const CreateView);
    case sqlast::AbstractStatement::Type::INSERT:
      return K9DB_VISIT_CAST(const Insert);
    case sqlast::AbstractStatement::Type::REPLACE:
      return K9DB_VISIT_CAST(const Replace);
    case sqlast::AbstractStatement::Type::UPDATE:
      return K9DB_VISIT_CAST(const Update);
    case sqlast::AbstractStatement::Type::DELETE:
      return K9DB_VISIT_CAST(const Delete);
    case sqlast::AbstractStatement::Type::SELECT:
      return K9DB_VISIT_CAST(const Select);
    case sqlast::AbstractStatement::Type::GDPR:
      return K9DB_VISIT_CAST(const GDPRStatement);
    case sqlast::AbstractStatement::Type::EXPLAIN_QUERY:
      return K9DB_VISIT_CAST(const ExplainQuery);
    default:
      assert(false);
  }
}
...
T AbstractStatement::Visit(MutableVisitor<T> *visitor) {
  switch (this->type()) {
    case sqlast::AbstractStatement::Type::CREATE_TABLE:
      return K9DB_VISIT_CAST(CreateTable);
    case sqlast::AbstractStatement::Type::CREATE_INDEX:
      return K9DB_VISIT_CAST(CreateIndex);
    case sqlast::AbstractStatement::Type::CREATE_VIEW:
      return K9DB_VISIT_CAST(CreateView);
    case sqlast::AbstractStatement::Type::INSERT:
      return K9DB_VISIT_CAST(Insert);
    case sqlast::AbstractStatement::Type::REPLACE:
      return K9DB_VISIT_CAST(Replace);
    case sqlast::AbstractStatement::Type::UPDATE:
      return K9DB_VISIT_CAST(Update);
    case sqlast::AbstractStatement::Type::DELETE:
      return K9DB_VISIT_CAST(Delete);
    case sqlast::AbstractStatement::Type::SELECT:
      return K9DB_VISIT_CAST(Select);
    case sqlast::AbstractStatement::Type::GDPR:
      return K9DB_VISIT_CAST(GDPRStatement);
    case sqlast::AbstractStatement::Type::EXPLAIN_QUERY:
      return K9DB_VISIT_CAST(ExplainQuery);
    default:
      assert(false);
  }
}
...
#endif  // K9DB_SQLAST_AST_VISITORS_H_
