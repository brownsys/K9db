#ifndef K9DB_SQLAST_AST_VALUE_H_
#define K9DB_SQLAST_AST_VALUE_H_
...
std::ostream &operator<<(std::ostream &os, const k9db::sqlast::Value &v);
...
template <>
struct hash<k9db::sqlast::Value> {
  size_t operator()(const k9db::sqlast::Value &o) const { return o.Hash(); }
};

}  // namespace std

#endif  // K9DB_SQLAST_AST_VALUE_H_
