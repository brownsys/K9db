#ifndef K9DB_DATAFLOW_SCHEMA_H_
#define K9DB_DATAFLOW_SCHEMA_H_
...
class SchemaFactory {
 ...
 public:
  ...
  static SchemaRef LIST_INDICES_SCHEMA;
  static SchemaRef SHOW_POLICIES_SCHEMA;
};

}  // namespace dataflow
}  // namespace k9db

#endif  // K9DB_DATAFLOW_SCHEMA_H_
