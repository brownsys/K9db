...
class DataFlowGraphGenerator {
 public:
  ...
  NodeIndex AddProjectOperator(NodeIndex parent, const std::vector<ColumnID> &column_ids);
  NodeIndex AddAggregateOperator(NodeIndex parent, const std::vector<ColumnID> &group_cols, AggregateFunctionEnum agg_func, ColumnID agg_col);
