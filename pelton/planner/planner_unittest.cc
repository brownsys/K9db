...
TEST(PlannerTest, ComplexQueryWithKeys) {
  ...
  EXPECT_EQ(graph.GetNode(1)->type(), dataflow::Operator::Type::FILTER);
  EXPECT_EQ(graph.GetNode(2)->type(), dataflow::Operator::Type::PROJECT);
  EXPECT_EQ(graph.GetNode(3).get(), graph.inputs().at("students").get());
  EXPECT_EQ(graph.GetNode(4)->type(), dataflow::Operator::Type::FILTER);
  EXPECT_EQ(graph.GetNode(5)->type(), dataflow::Operator::Type::EQUIJOIN);
  EXPECT_EQ(graph.GetNode(6)->type(), dataflow::Operator::Type::PROJECT);
  EXPECT_EQ(graph.GetNode(7).get(), graph.inputs().at("assignments").get());
  EXPECT_EQ(graph.GetNode(8)->type(), dataflow::Operator::Type::FILTER);
  EXPECT_EQ(graph.GetNode(9)->type(), dataflow::Operator::Type::PROJECT);
  EXPECT_EQ(graph.GetNode(10)->type(), dataflow::Operator::Type::EQUIJOIN);
  EXPECT_EQ(graph.GetNode(11)->type(), dataflow::Operator::Type::PROJECT);
  EXPECT_EQ(graph.GetNode(12)->type(), dataflow::Operator::Type::AGGREGATE);
  EXPECT_EQ(graph.GetNode(13).get(), graph.outputs().at(0).get());
