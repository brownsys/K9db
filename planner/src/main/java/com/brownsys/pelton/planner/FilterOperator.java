...
public class FilterOperator extends Operator{
	...
	public FilterOperator(Integer id, ArrayList<Integer> cids, ArrayList<String> ops, ArrayList<String> vals, ArrayList<String> valTypes, ArrayList<String> outSchema){
		this.id = id;
		this.name = "Filter";
		this.cids = cids;
		this.ops = ops;
