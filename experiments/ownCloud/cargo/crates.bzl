...
def raze_fetch_remote_crates():
    ...
    maybe(
        http_archive,
        name = "raze__derive_utils__0_11_2",
        url = "https://crates.io/api/v1/crates/derive_utils/0.11.2/download",
        type = "tar.gz",
        sha256 = "532b4c15dccee12c7044f1fcad956e98410860b22231e44a3b827464797ca7bf",
        strip_prefix = "derive_utils-0.11.2",
        build_file = Label("//cargo/remote:BUILD.derive_utils-0.11.2.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "raze__io_enum__0_2_6",
        url = "https://crates.io/api/v1/crates/io-enum/0.2.6/download",
        type = "tar.gz",
        sha256 = "94534fd32a986dd34d97ddefe5198630d5ed99efd4e9b9b9ed4359e6b23a9cf7",
        strip_prefix = "io-enum-0.2.6",
        build_file = Label("//cargo/remote:BUILD.io-enum-0.2.6.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.lru-0.6.6.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "raze__mysql__20_1_0",
        url = "https://crates.io/api/v1/crates/mysql/20.1.0/download",
        type = "tar.gz",
        sha256 = "e5a8660184af84975ac1639aa692a539c37739cec8a22a414de3db9cb573c1aa",
        strip_prefix = "mysql-20.1.0",
        build_file = Label("//cargo/remote:BUILD.mysql-20.1.0.bazel"),
    )

    maybe(
        http_archive,
        name = "raze__mysql_common__0_24_1",
        url = "https://crates.io/api/v1/crates/mysql_common/0.24.1/download",
        type = "tar.gz",
        sha256 = "de63b87a5f24c5db252418a6f04abb2f62823bd838dc9b1d7fdb8ae972ef76cf",
        strip_prefix = "mysql_common-0.24.1",
        build_file = Label("//cargo/remote:BUILD.mysql_common-0.24.1.bazel"),
    )

    maybe(
        http_archive,
        name = "raze__named_pipe__0_4_1",
        url = "https://crates.io/api/v1/crates/named_pipe/0.4.1/download",
        type = "tar.gz",
        sha256 = "ad9c443cce91fc3e12f017290db75dde490d685cdaaf508d7159d7cf41f0eb2b",
        strip_prefix = "named_pipe-0.4.1",
        build_file = Label("//cargo/remote:BUILD.named_pipe-0.4.1.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "raze__nix__0_19_1",
        url = "https://crates.io/api/v1/crates/nix/0.19.1/download",
        type = "tar.gz",
        sha256 = "b2ccba0cfe4fdf15982d1674c69b1fd80bad427d293849982668dfe454bd61f2",
        strip_prefix = "nix-0.19.1",
        build_file = Label("//cargo/remote:BUILD.nix-0.19.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.pem-0.8.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.rust_decimal-1.22.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.twox-hash-1.6.2.bazel"),
    )
