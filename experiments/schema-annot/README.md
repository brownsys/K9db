...
- `commento`: 3 `DATA_SUBJECT`, 8 `OWNED_BY`, 2 `ACCESSED_BY`, 2 `ON GET ANON`, 1 `ON DEL DELETE_ROW`
...
- `hotcrp`: 2 `DATA_SUBJECT`, 14 `OWNED_BY`, 1 `OWNS`, 10 `ACCESSED_BY`, 4 `ON GET ANON`, 3 `ON DEL ANON`
