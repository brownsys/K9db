...
CREATE TABLE hats ( id int NOT NULL PRIMARY KEY, created_at datetime, updated_at datetime, user_id int, granted_by_user_id int, hat varchar(255) NOT NULL, link varchar(255), modlog_use int, doffed_at datetime) ENGINE=ROCKSDB DEFAULT CHARSET=utf8;
...
CREATE TABLE invitation_requests ( id int NOT NULL PRIMARY KEY, code varchar(255), is_verified int, email varchar(255), name varchar(255), memo text, ip_address varchar(255), created_at datetime NOT NULL, updated_at datetime NOT NULL) ENGINE=ROCKSDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE invitations ( id int NOT NULL PRIMARY KEY, user_id int, email varchar(255), code varchar(255), created_at datetime NOT NULL, updated_at datetime NOT NULL, memo text) ENGINE=ROCKSDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE messages ( id int NOT NULL PRIMARY KEY, created_at datetime, author_user_id int, recipient_user_id int, has_been_read int, subject varchar(100), body text, short_id varchar(30), deleted_by_author int, deleted_by_recipient int) ENGINE=ROCKSDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE moderations ( id int NOT NULL PRIMARY KEY, created_at datetime NOT NULL, updated_at datetime NOT NULL, moderator_user_id int, story_id int, comment_id int, user_id int, `action` text, reason text, is_from_suggestions int) ENGINE=ROCKSDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE votes ( id int NOT NULL PRIMARY KEY, user_id int NOT NULL, story_id int NOT NULL, comment_id int, vote int NOT NULL, reason varchar(1)) ENGINE=ROCKSDB DEFAULT CHARSET=utf8;
CREATE INDEX votes_user_id ON votes (user_id);
CREATE INDEX votes_user_comment ON votes (user_id, comment_id);
CREATE INDEX votes_user_story ON votes (user_id, story_id);
