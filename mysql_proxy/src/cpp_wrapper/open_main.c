...
int main(int argc, char **argv) {
  ...
  int response_insert2 = exec_update(&c_conn, "INSERT INTO test3 VALUES (2);");
  // int response_update = exec_update(&c_conn, "UPDATE test3 SET my_column=2
  // WHERE my_column=1;"); int response_delete = exec_update(&c_conn, "DELETE
  // FROM test3 WHERE my_column=2;");
